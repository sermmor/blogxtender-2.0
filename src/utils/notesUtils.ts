...
/**
 * Converts text with {note} syntax into HTML footnotes.
 * Returns [textWithoutNotes, notesContent].
 */
...
/**
 * Converts HTML footnotes back to {note} syntax.
 * Returns [newContent, extractedTitle, hasNotes].
 */
