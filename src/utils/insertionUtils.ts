...
/**
 * Builds the HTML skeleton of a table.
 */
...
/**
 * Returns [openTag, closeTag] for a colored underline span.
 */
...
/**
 * Returns [openTag, closeTag] for a quote.
 */
...
/**
 * Builds the full HTML for an image with caption.
 */
...
/**
 * Builds the HTML for a lateral/pull-quote phrase.
 */
...
/**
 * Builds the HTML for a YouTube embed with caption.
 */
...
/**
 * Builds the HTML for a self-contained image gallery widget.
 */
...
/**
 * Builds a formatted news reference for the notes zone.
 */
